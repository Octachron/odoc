...
\label{package-test+u+package+++ml-module-Stop-val-foo}\ocamlcodefragment{\begin{keyword}val\end{keyword}
...
\label{package-test+u+package+++ml-module-Stop-module-N}\ocamlcodefragment{\begin{keyword}module\end{keyword}
 \hyperref[package-test+u+package+++ml-module-Stop-module-N]{\ocamlinlinecode{N}}}\ocamlcodefragment{ : \begin{keyword}sig\end{keyword}
}\begin{ocamlindent}\label{package-test+u+package+++ml-module-Stop-module-N-val-quux}\ocamlcodefragment{\begin{keyword}val\end{keyword}
 quux : int}\\
\end{ocamlindent}%
\ocamlcodefragment{\begin{keyword}end\end{keyword}
}\\
\label{package-test+u+package+++ml-module-Stop-val-lol}\ocamlcodefragment{\begin{keyword}val\end{keyword}
 lol : int}\\
